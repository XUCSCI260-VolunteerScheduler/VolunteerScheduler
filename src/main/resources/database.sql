...
ALTER TABLE PUBLIC.EVENT ADD CONSTRAINT PUBLIC.CONSTRAINT_3F4 FOREIGN KEY(E_EMPLOYEEORG) REFERENCES PUBLIC.WORKER(W_EMAIL) NOCHECK;            
ALTER TABLE PUBLIC.STUDENT ADD CONSTRAINT PUBLIC.CONSTRAINT_BA FOREIGN KEY(S_EMAIL) REFERENCES PUBLIC.VOLUNTEER(V_EMAIL) NOCHECK;              
ALTER TABLE PUBLIC.LOGIN ADD CONSTRAINT PUBLIC.CONSTRAINT_45 FOREIGN KEY(L_EMAIL) REFERENCES PUBLIC.PERSON(P_EMAIL) NOCHECK;   
...
ALTER TABLE PUBLIC.VOLUNTEER ADD CONSTRAINT PUBLIC.CONSTRAINT_27 FOREIGN KEY(V_EMAIL) REFERENCES PUBLIC.PERSON(P_EMAIL) NOCHECK;               
ALTER TABLE PUBLIC.AVAILABLETIME ADD CONSTRAINT PUBLIC.CONSTRAINT_297 FOREIGN KEY(AT_VOLUNTEER) REFERENCES PUBLIC.VOLUNTEER(V_EMAIL) NOCHECK;  
ALTER TABLE PUBLIC.VOLUNTEERTAG ADD CONSTRAINT PUBLIC.CONSTRAINT_C49 FOREIGN KEY(VT_TAG) REFERENCES PUBLIC.TAG(T_NAME) NOCHECK;
ALTER TABLE PUBLIC.VOLUNTEERTAG ADD CONSTRAINT PUBLIC.CONSTRAINT_C4 FOREIGN KEY(VT_VOLUNTEER) REFERENCES PUBLIC.VOLUNTEER(V_EMAIL) NOCHECK;    
ALTER TABLE PUBLIC.VOLUNTEEREVENT ADD CONSTRAINT PUBLIC.CONSTRAINT_1A1 FOREIGN KEY(VE_VOLUNTEER) REFERENCES PUBLIC.VOLUNTEER(V_EMAIL) NOCHECK; 
ALTER TABLE PUBLIC.ORGANIZATION ADD CONSTRAINT PUBLIC.CONSTRAINT_D0 FOREIGN KEY(O_ORGANIZER) REFERENCES PUBLIC.WORKER(W_EMAIL) NOCHECK;        
ALTER TABLE PUBLIC.WORKER ADD CONSTRAINT PUBLIC.CONSTRAINT_98 FOREIGN KEY(W_EMAIL) REFERENCES PUBLIC.PERSON(P_EMAIL) NOCHECK;  
