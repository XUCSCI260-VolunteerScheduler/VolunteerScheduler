...
CREATE MEMORY TABLE PUBLIC.SCHOOL(
    SCH_ID INTEGER NOT NULL AUTO_INCREMENT(1, 1),
...
CREATE MEMORY TABLE PUBLIC.ORGANIZATION(
    O_ID INTEGER NOT NULL AUTO_INCREMENT(1,1),
...
CREATE MEMORY TABLE PUBLIC.EVENT(
    E_ID INTEGER NOT NULL AUTO_INCREMENT(1,1),
...
CREATE MEMORY TABLE PUBLIC.VOLUNTEEREVENT(
    VE_ID INTEGER NOT NULL AUTO_INCREMENT(1,1),
